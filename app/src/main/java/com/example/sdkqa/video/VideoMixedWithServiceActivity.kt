...
class VideoMixedWithServiceActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val LIVE_ID = "5fd39e065d68477eaa1ccf5a"
    ...
    private fun startService(config: MediastreamPlayerConfig) {
        ...
        MediastreamPlayerServiceWithSync.initializeService(
            this,
            this@VideoMixedWithServiceActivity,
            config,
            container,
            playerView,
            miniPlayerConfig,
    ...
    private fun createPlayerCallback(): MediastreamPlayerCallback {
        return object : MediastreamPlayerCallback {
            ...
            override fun onError(error: String?) {
                ...
                Toast.makeText(this@VideoMixedWithServiceActivity, error, Toast.LENGTH_LONG).show()
            }
